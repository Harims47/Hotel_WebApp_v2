      ...
      <Card>
        <div className="p-4 border-b border-border bg-gray-50/50">
          <div className="w-full md:w-80">
            <SearchInput 
              placeholder="Search by waste number..." 
              value={search} 
        ...
        <div className="overflow-x-auto w-full">
          <Table>
            ...
            <tbody>
              {paginated.length === 0 ? (
                <tr><td colSpan="7"><EmptyState icon={Trash2} title={search ? "No matches found" : "No waste records"} description={search ? "Try adjusting your search." : "Record waste items here."} /></td></tr>
              ) : paginated.map(w => (
